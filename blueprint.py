...
description = ActionProviderDescription(
    ...
    globus_auth_scope="https://auth.globus.org/scopes/3c5d0e04-cba1-4c39-b098-fb8e9c45c3d2/action_all",
...
def my_action_run(
    ...
    """
    details = requests.get("https://s3m.apps.olivine.ccs.ornl.gov/olcf/v1alpha/status", timeout=5).json() 
    print(details)
